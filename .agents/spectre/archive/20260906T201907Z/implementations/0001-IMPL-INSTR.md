# XRAY Mini App Cardano Transactions implementation 0001 instruction
...
Install SPECTRE 1.0.0 and validate its tracking structure for XRAY Mini App Cardano Transactions.
