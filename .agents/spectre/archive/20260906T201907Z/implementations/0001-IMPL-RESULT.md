# XRAY Mini App Cardano Transactions implementation 0001 result

Result-Version: v1
Implementation-ID: xray-mini-app-transactions/0001
...
Installed SPECTRE 1.0.0 for XRAY Mini App Cardano Transactions and replaced the active XRAY Updates installation. Historical terminal work is available through the SPECTRE archive; planned work remains active.
